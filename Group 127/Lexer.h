...
unordered_set<string> keywords = {"let", "where", "within", "aug", "fn", "in"};
unordered_set<string> operators = {"and", "or", "not", "gr", "ge", "ls", "le", "eq", "ne"};
unordered_set<string> booleanValues = {"true", "false"};
